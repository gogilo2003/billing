...
<div class="row wow fadeIn">
    ...
    <div class="col-md-8 pb-2">
        ...
        <div class="card ">
            ...
            <div class="card-footer">
                <div class="stats">
                    <i class="fa fa-check"></i> Transactions for the past 12 Months. Starting {{ $start->format('j F, Y') }} to {{ $today->format('j F, Y') }}
                </div>
            </div>
        </div>
            ...
            var myPieChart = new Chart(ctxP, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        borderWidth: 1,
                        backgroundColor: ["rgba(54, 162, 235, 0.75)", "rgba(255, 99, 132, 0.75)", "rgba(255, 206, 86, 0.75)"],
                        hoverBackgroundColor: ["rgba(54, 162, 235, 0.4)", "rgba(255, 99, 132, 0.4)", "rgba(255, 206, 86, 0.4)"]
                    }]
                },
                options: {
                    responsive: true
